...
import { autorunOpts, derived, derivedOpts, IObservable, ITransaction, observableFromEvent, observableSignal } from 'vs/base/common/observable';
import { observableValue, observableValueOpts, TransactionImpl } from 'vs/base/common/observableInternal/base';
...
class ObservableCodeEditor extends Disposable {
	...
	*/
	...
	private readonly _versionId = observableValue<number | null, IModelContentChangedEvent | undefined>(this, this.editor.getModel()?.getVersionId() ?? null);
	...
	private readonly _selections = observableValueOpts<Selection[] | null, ICursorSelectionChangedEvent | undefined>(
		{ owner: this, equalsFn: equalsIfDefined(itemsEquals(Selection.selectionsEqual)) },
